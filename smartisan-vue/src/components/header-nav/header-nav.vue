    ...
    <div class="nav-global">
      <div class="container">
        ...
        <ul class="nav-aside">
          ...
          <!--active-->
          <li class="nav-cart" :class="{active : isShow}" @mouseenter="isShow = true" @mouseleave="isShow = false">
            <a href="javascript:;">购物车</a>
            <!--根据class改变颜色-->
            <span class="cart-empty-num cart-num">
              <i>{{smallCarNum}}</i>
            </span>
            <small-car-shop></small-car-shop>
          </li>
        </ul>
        <ul class="nav-list">
          <li>
...
<script>
import SmallCarShop from './small-car-shop'
